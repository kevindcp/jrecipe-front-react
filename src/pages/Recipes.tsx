...
const RecipesPage = () => {
  ...
  return (
    <Flex justify='center' h='auto' w='100%' align='left' pl='10vw' pt='5vh' pb='3vh' zIndex='0' flexDirection='column'>
      ...
      </Grid> :<VStack> <Text w='100%' fontSize='3.2vh'> You have no recipes yet :( </Text> <Link w='100%' fontSize='2.5vh' fontWeight='600' onClick={()=> history('/recipes/add')}>Click here to create one</Link></VStack>}
    </Flex>
  )
}
