...
const CategoryPage = () => {
  ...
  return (
    <Flex justify='center' h='auto' w='100%' align='left' pl='10vw' pt='5vh' pb='3vh' zIndex='0' flexDirection='column'>
      ...
      </Grid> :<VStack> <Text w='100%' fontSize='2em'> You have no recipes in this category yet :( </Text> <Link w='100%' fontSize='1.8em' fontWeight='600' onClick={()=> history('/recipes/add')}>Click here to create one</Link></VStack>}
    </Flex>
  )
}
